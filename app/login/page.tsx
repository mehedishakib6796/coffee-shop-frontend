    ...
    <main className="min-h-screen bg-[#0f0a07] text-white flex overflow-hidden font-sans">
      ...
      >
        <div className="relative z-10 text-center">
          ...
          <h1 className="text-7xl font-black uppercase tracking-tighter leading-[0.85] mb-8">
            Welcome <br />
            Back to <span className="text-[#d4a373]">Cove</span>
          </h1>
          <p className="text-gray-500 max-w-sm mx-auto text-lg font-light leading-relaxed">
            Ready for your daily dose of perfection? Log in to access your rewards and favorite blends.
          </p>
        </div>
      ...
      >
        ...
        <div className="w-full max-w-[400px] relative z-10">
          <div className="mb-12">
            <span className="text-[#d4a373] text-[10px] font-black uppercase tracking-[0.4em] block mb-3">
              Secure Access
            </span>
            <h2 className="text-5xl font-black uppercase tracking-tighter mb-2">Login</h2>
            <p className="text-gray-600 text-sm font-medium uppercase tracking-widest">Great to see you again</p>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center px-1">
                <label className="text-[10px] uppercase tracking-[0.2em] font-black text-gray-500">Password</label>
                <Link href="#" className="text-[10px] text-[#d4a373] hover:underline uppercase font-bold tracking-tighter">Forgot?</Link>
              </div>
              <input 
                type="password" 
                placeholder="••••••••"
            ...
            <div className="pt-2">
              <button 
                type="submit"
                className="w-full bg-[#d4a373] text-black py-4 rounded-2xl font-black uppercase tracking-widest text-xs shadow-2xl hover:bg-white hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 h-14"
              >
                Sign In
              </button>
            </div>
          ...
          <div className="mt-12 text-center border-t border-white/5 pt-8">
            <p className="text-gray-600 text-[10px] uppercase tracking-[0.2em] font-bold">
              New to the Cove?{" "}
              <Link href="/signup" className="text-[#d4a373] font-black hover:text-white transition-colors ml-1">
                Create Account
              </Link>
            </p>
          </div>
